export const name = 'imagekit-input' as const

// Caching namespace, as suspend-react might be in use by other components on the page we must ensure we don't collide
export const cacheNs = 'sanity-plugin-imagekit-input' as const

export const imageKitSecretsDocumentId = 'secrets.imagekit' as const
