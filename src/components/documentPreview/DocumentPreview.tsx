...
export function getIconWithFallback(
  // eslint-disable-next-line @typescript-eslint/no-explicit-any -- React component types require flexibility
  ...
  // eslint-disable-next-line @typescript-eslint/no-explicit-any -- Schema icon type requires flexibility
