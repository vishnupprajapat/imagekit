...
import {type PluginConfig, SUPPORTED_LANGUAGES, UploadTextTrack} from '../util/types'
...
const SUBTITLE_LANGUAGES: Record<UploadTextTrack['type'], {value: string; label: string}[]> = {
  autogenerated: SUPPORTED_LANGUAGES.map((lang) => ({
    value: lang.code,
    label: lang.label,
  })),
