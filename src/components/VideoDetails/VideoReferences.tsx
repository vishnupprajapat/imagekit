...
const Container = styled(Box)`
  * {
    color: ${(props: unknown) =>
      (props as {theme: {sanity: {color: {base: {fg: string}}}}}).theme.sanity.color.base.fg};
  }
  a {
    text-decoration: none;
  }
  h2 {
    font-size: ${(props: unknown) =>
      (props as {theme: {sanity: {fonts: {text: {sizes: string[]}}}}}).theme.sanity.fonts.text
        .sizes[1]};
  }
`
